...
const SCENES = [
  ...
  },
  {
    icon: IconShield,
    title: '灾害应急通信',
    desc: '地震、洪水、台风导致基站瘫痪时，快速搭建临时通信网络维持指挥链路，面向国内山地防灾、乡村应急与森林防火。',
    points: ['断网环境自组网指挥', '救援队协同调度与位置态势回传', '森林防火 / 水文监测告警优先传输', '乡村应急广播与山野值守'],
    tag: 'Backbone + Walk',
  },
  {
    icon: IconNetwork,
  ...
  },
  {
    ...
    title: '野外传感数据采集',
    desc: '无人值守区域的环境监测、资产追踪与遥测数据长期回传，可扩展至水文监测与森林防火巡检。',
    points: ['ESP32-C3 超低功耗', '深度休眠不丢包', '温湿度 / 位置遥测', '水文监测与森林防火巡检'],
    tag: 'Sensor 传感终端',
  },
];
...
export default function ScenariosPage() {
  return (
    <MrPage
      title="应用场景"
      description="MeshROC 应用场景：户外徒步、灾害应急、城市 Mesh、山地远距离组网、HAM 爱好者、野外传感采集、森林防火、水文监测、乡村应急。"
    >
      <MrHeader
        eyebrow="Use Cases"
        title="应用场景"
        lead="从西南深山到沿海丘陵，从西北戈壁到青藏高原——MeshROC 面向一切没有基础设施、或基础设施不可靠的通信需求，尤其是国内山地防灾、乡村应急、森林防火与野外监测。"
      />
